...
function ShopProduct(props) {
    ...
    return (
        <div
            id={id}
            className="relative pb-3 cursor-pointer flex-item-product group"
        >
            <div
                className='relative h-[165px] text-center'
            >
                <LazyLoadImage
                    effect='blur'
                    src={img}
            ...
            >
                <div className='flex flex-1 flex-col'>
                    <div
                        className='font-semibold text-lg mt-2 mb-[6px]'
                    >
                        {name}
                    </div>
                    <p

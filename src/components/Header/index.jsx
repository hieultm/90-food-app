    ...
    return (
        <>
            <header
                className={
                    showNavbar
                        ? 'bg-navbar-food mt-0 fixed !w-full transition easy-in-out delay-150 z-[900]'
                        : ' mt-1 !w-full sm:!w-full fixed z-[900]'
                }
                        ...
                        <ul className="flex ml-auto tablet:mr-unset">
                            ...
                            {user ? (
                                ...
                                invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:top-[55px]"
                                    >
                                        <li className="flex items-center text-sm py-[6px] px-4 hover:bg-zinc-200">
                                ...
                                <div
                                    onClick={handleLogin}
                                    className="flex items-center text-base mx-8 cursor-pointer tablet:hidden"
                                >
                                    <Avatar />
                                    <label
                                        className="text-white items-center text-lg cursor-pointer ml-[0.85rem] hover:text-red-500"

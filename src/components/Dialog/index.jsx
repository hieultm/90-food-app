...
function Dialog(props) {
    ...
    return (
        <div className={
            isShow ? "fixed inset-0 z-[999] flex visible"
            : "fixed inset-0 z-[999] flex invisible"
        }> 
            <div
                className={
                    isShow ? "absolute w-full h-full bg-dialog-overlay transition-all delay-[.25s] ease-out opacity-100"
            ...
            <div 
                className={
                    isShow ? "z-10 m-auto p-5 rounded-md shadow-btnLogin bg-white transition-all delay-[.5s] ease-linear translate-y-0 visible opacity-100"
            ...
            >
                <h2 className="text-xl uppercase mb-4 font-semibold">
                    Join with us
                </h2>

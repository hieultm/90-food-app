import { BannerOne, BannerSecond, BannerThree } from './homeImages';

import { Burger, Coffee, Pork, Lunch, Juice, Chicken, Beef } from './homeImages';
...
export { homeBannersData, navbarName, homeCategoryData };
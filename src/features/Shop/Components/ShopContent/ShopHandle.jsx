...
function ShopHandle() {
    ...
    return (
        <div
            className="flex items-start tablet:mb-5" 
        >
            <form 
                value={inputValue}
            ...
            >
                ...
                />
                <button
                    className='w-8 h-8 ml-auto bg-none'
                >
            ...
            >
                ...
                <ul
                    className={
                        isDrop ? "absolute z-[999] border-[1px] border-solid border-zinc-400 rounded-md mt-2 py-2 shadow-dropList translate-y-3 visible opacity-1 bg-white w-full transition-all cursor-pointer" 
                        : 
